...
const HomeScreen = () => {
  ...
  const globalList = listAllProperties?.length ? listAllProperties : [];
        ...
        >
          ...
          {listAllPropertiesLoading ? (
            ...
            <View style={styles.emptyBox}>
              ...
              <Text style={styles.emptyTitle}>Belum ada data global</Text>
              <Text style={styles.emptyCaption}>
                Properti global belum tersedia saat ini.
              </Text>
            </View>
          )}
        </Animated.View>
