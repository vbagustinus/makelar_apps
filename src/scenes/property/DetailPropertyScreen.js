  ...
  return (
    <View style={styles.screen}>
      <ScrollView
        ...
        contentContainerStyle={{ paddingTop: Sizes.statusBar + 10, backgroundColor: Colors.BACKGROUND, paddingBottom: 100 }}
      >
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.subtitle}>{item.propertyTypeName || item.propertyType?.name || ''}</Text>
