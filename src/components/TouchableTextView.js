...
import { Alignments, Colors, Fonts, Sizes } from '../constants';
import { IconDropRight } from '../assets/images';
  ...
  <View style={props.containerStyle}>
    ...
    <TouchableOpacity
      ...
      style={[
        ...
        props.center && { ...Alignments.center },
        {
    ...
    >
      ...
      <IconDropRight style={styles.dropDownIcon} />
    </TouchableOpacity>
  </View>
);
